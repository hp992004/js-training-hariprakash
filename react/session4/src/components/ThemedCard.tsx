...
/*
Calling `useTheme()` in a normal function causes an "Invalid hook call" error.
Hooks only work inside React components or custom hooks.
This rule helps React manage state correctly.
*/